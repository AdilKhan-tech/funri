        ...
        <div className="col-md-9">
            ...
            <div className="card-body">
              <div className="row align-items-center">
                <div className="col-md-2">
                  <img src="/images/product-1.png" alt="Product" className="img-fluid rounded" />
                </div>
          ...
          <div className="card border-0 shadow-sm mb-4">
            ...
            <div className="card-body">
              <div className="row align-items-center">
                <div className="col-md-2">
                  <img src="/images/product-2.png" alt="Product" className="img-fluid rounded" />
                </div>
                <div className="col-md-6">
          ...
          <div className="card border-0 shadow-sm mb-4">
            ...
            <div className="card-body">
              <div className="row align-items-center">
                <div className="col-md-2">
                  <img src="/images/product-3.png" alt="Product" className="img-fluid rounded" />
                </div>
                <div className="col-md-6">
