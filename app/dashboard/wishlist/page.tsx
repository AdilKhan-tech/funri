...
export default function Wishlist() {
  const wishlistItems = [
    { id: 1, name: 'Modern Sofa Set', price: 299.99, image: '/images/product-1.png', inStock: true },
    { id: 2, name: 'Dining Table Chair', price: 149.50, image: '/images/product-2.png', inStock: true },
    { id: 3, name: 'Office Desk Lamp', price: 89.99, image: '/images/product-3.png', inStock: false },
    { id: 4, name: 'Bookshelf Unit', price: 199.99, image: '/images/product-1.png', inStock: true },
  ];
