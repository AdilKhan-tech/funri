          ...
          <div className="row">
            ...
            <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
              <Link className="product-item" href="/cart">
                <img src="/assets/images/product-1.png" className="img-fluid product-thumbnail" alt="Nordic Chair" />
            ...
            <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
              <Link className="product-item" href="/cart">
                <img src="/assets/images/product-2.png" className="img-fluid product-thumbnail" alt="Kruzo Aero Chair" />
            ...
            <div className="col-12 col-md-4 col-lg-3 mb-5 mb-md-0">
              <Link className="product-item" href="/cart">
                <img src="/assets/images/product-3.png" className="img-fluid product-thumbnail" alt="Ergonomic Chair" />
