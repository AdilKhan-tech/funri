            ...
            <div className="card-body p-4">
              ...
              <div className="table-responsive">
                <table className="table table-hover align-middle">
                  ...
                  <tbody>
                    <tr>
                      <td><img src="/assets/images/product-1.png" alt="Product" style={{width: '50px', height: '50px', objectFit: 'cover', borderRadius: '4px'}} /></td>
                    ...
                    <tr>
                      <td><img src="/assets/images/product-2.png" alt="Product" style={{width: '50px', height: '50px', objectFit: 'cover', borderRadius: '4px'}} /></td>
                    ...
                    <tr>
                      <td><img src="/assets/images/product-3.png" alt="Product" style={{width: '50px', height: '50px', objectFit: 'cover', borderRadius: '4px'}} /></td>
